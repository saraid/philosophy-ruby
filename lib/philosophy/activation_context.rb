module Philosophy
  class ActivationContext
    ...
    def place(player:, tile:, location:, direction:, first_move: false, ignore_errors: false)
      ...
      raise PErr::InvalidFirstMove, location if first_move && spaces[location].name == :C5
